...
def _get_patches_generic(img, patch_size, is_train, stride):
    ...
    # img2 = resize(img, 0.5, order=3 )

    img2 = scipy.misc.imresize(img, 0.5, interp='bicubic', mode='F')
    # img2 = np.array(Image.fromarray(img).resize((int(img.shape[0]*0.5),int(img.shape[1]*0.5)),Image.BICUBIC))
...
def niqe(inputImgData):
    ...
    # TODO: memoize
    params = scipy.io.loadmat(join(module_path, 'niqe_data', 'niqe_image_params.mat'))

...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--visual_freq', type=int, default=1000, help='frequency of show training images in tensorboard')  # 400
        parser.add_argument('--print_freq', type=int, default=1000, help='frequency of showing training results on console') #100
        # network saving and loading parameters
        parser.add_argument('--save_iter_freq', type=int, default=10000, help='frequency of saving the models')#500
        ...
        parser.add_argument('--gpu_ids', type=int, default=[1, 0], help='gpu_ids to use')

...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='jsfmgan', help='chooses which model to train [parse|enhance]')
        ...
        # dataset parameters
        parser.add_argument('--dataset_name', type=str, default='test', help='dataset name')
        ...
        parser.add_argument('--num_workers', default=0, help='num_workers>0')

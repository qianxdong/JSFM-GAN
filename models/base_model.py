...
class BaseModel(ABC):
    ...
    def get_D_lr(self,):
        lrs = {}
        for idx, p in enumerate(self.optimizers_D):
            lrs['LR{}'.format(idx)] = p.param_groups[0]['lr']
        return lrs

    def get_G_lr(self,):
        lrs = {}
        for idx, p in enumerate(self.optimizers_G):
            lrs['LR{}'.format(idx)] = p.param_groups[0]['lr']
        return lrs
    # ========================================
    ...
    # def get_gragh(self):
    #     """Return visualization images. train.py will display these images with visdom, and save the images to a HTML"""
    #     visual_net = OrderedDict()
    #     for name in self.model_names:
    #         if isinstance(name, str):
    #             visual_net[name] = getattr(self, name)
    #     return visual_net

    def get_current_losses(self):
        """Return traning losses / errors. train.py will print out these errors on console, and save them to a file"""
        errors_ret = OrderedDict()  # 有序字典类
